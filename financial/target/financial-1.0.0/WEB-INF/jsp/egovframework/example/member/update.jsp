  ...
  <head>
    ...
    <body>
        ...
        <div class="masthead">
            ...
            <form name="frm" class="form-horizontal" role="form" method="post" action="/updateAction.do">
                <div class="form-group" id="divId">
                    <div class="col-lg-10">
                        <input type="hidden" class="form-control onlyAlphabetAndNumber" id="idx" name="idx" data-rule-required="true" value="${userIdx }">
                    </div>
                </div>
                <div class="form-group" id="divId">
                    <div class="col-lg-10">
                    ID cannot be changed.
                        <input type="text" class="form-control onlyAlphabetAndNumber" id="id" name="id" data-rule-required="true" placeholder="ID" maxlength="15" value="${userId }" readonly>
                    </div>
                </div>
                ...
                <div class="form-group" id="divName">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control onlyHangul" id="name" name="name" data-rule-required="true" placeholder="Enter" maxlength="15" value="${userName }">
                    </div>
                </div>
                <div class="form-group" id="divPhoneNumber">
                    <div class="col-lg-10">
                    Phone Number
                        <input type="tel" class="form-control onlyNumber" id="phone_number" name="phone_number" data-rule-required="true" placeholder="Enter only numbers" maxlength="11" value="${userPhoneNumber }">
                    </div>
                </div><br/>
